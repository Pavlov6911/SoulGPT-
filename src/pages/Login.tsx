...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] flex items-center justify-center px-4 transition-colors duration-300">
      {/* Back Button */}
      <motion.button
      ...
      >
        <div className="bg-white dark:bg-[#0a0a0a] border border-black dark:border-white rounded-2xl p-8 shadow-lg dark:shadow-white/10">
          ...
          >
            ...
            <p className="text-black/70 dark:text-white/70">Welcome back</p>
          </motion.div>
